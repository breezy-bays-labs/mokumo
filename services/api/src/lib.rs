...
// `mokumo_shop::startup` in PR 4b (#512). CLI direct-path helpers
// (cli_backup, cli_restore, cli_reset_db, cli_reset_password,
// cli_migrate_status, plus their types) moved to `mokumo_shop::cli`.
// Re-exports preserved for BDD tests until B3-bulk migrates them.
pub use mokumo_shop::cli::{
    DB_SIDECAR_SUFFIXES, MigrateStatusReport, MigrationRecord, ResetError, ResetReport, cli_backup,
    cli_migrate_status, cli_reset_db, cli_reset_password, cli_restore,
};
pub use mokumo_shop::startup::{
