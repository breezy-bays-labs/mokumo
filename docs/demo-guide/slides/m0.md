...
<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: GitHub Releases — Windows installer download</div>
...
<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: Windows SmartScreen — "More info" dialog</div>
...
<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: NSIS installer prompts</div>
...
<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: Windows — setup wizard launch</div>
...
<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: GitHub Releases — macOS .dmg download</div>

<v-click>

**Step 1:** Open the `.dmg` and drag Mokumo to your Applications folder.

<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: macOS — drag to Applications</div>
...
<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: macOS Gatekeeper — right-click Open</div>
...
<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: macOS Gatekeeper — confirm Open</div>
...
<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: macOS — setup wizard launch</div>
...
<img src="/m0/10-setup-wizard-shop-name.png" alt="Setup wizard — shop name" class="rounded shadow" />
...
<img src="/m0/11-setup-wizard-password.png" alt="Setup wizard — admin password" class="rounded shadow" />
...
<img src="/m0/12-setup-wizard-recovery-code.png" alt="Setup wizard — recovery code" class="rounded shadow" />
...
<img src="/m0/13-login-screen.png" alt="Login screen" class="rounded shadow" />
...
<img src="/m0/14-dashboard-after-login.png" alt="Dashboard after login" class="rounded shadow" />
...
<img src="/m0/15-sidebar-navigation.png" alt="Sidebar navigation" class="rounded shadow" />
...
<img src="/m0/16-sidebar-collapsed.png" alt="Sidebar collapsed" class="rounded shadow" />
...
<img src="/m0/17-empty-state-customers.png" alt="Empty state — customers" class="rounded shadow" />
...
<img src="/m0/18-theme-switcher.png" alt="Theme switcher" class="rounded shadow" />
...
<img src="/m0/19-new-customer-button.png" alt="New customer button" class="rounded shadow" />
...
<img src="/m0/20-customer-form-filled.png" alt="Customer form filled" class="rounded shadow" />
...
<img src="/m0/21-customer-detail.png" alt="Customer detail view" class="rounded shadow" />
...
<img src="/m0/22-customer-edit.png" alt="Customer edit form" class="rounded shadow" />
...
<img src="/m0/23-customer-search.png" alt="Customer search" class="rounded shadow" />
...
<img src="/m0/24-customer-kpi-cards.png" alt="Customer KPI cards" class="rounded shadow" />
...
<img src="/m0/25-soft-delete-confirm.png" alt="Soft delete confirmation" class="rounded shadow" />
...
<img src="/m0/26-show-deleted-toggle.png" alt="Show deleted toggle" class="rounded shadow" />
...
<img src="/m0/27-restore-customer.png" alt="Restore customer" class="rounded shadow" />
...
<img src="/m0/28-activity-log-list.png" alt="Activity log list" class="rounded shadow" />
...
<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: Activity log — entity type filter</div>
...
<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: LAN — second device connection</div>
...
<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: Two devices side by side</div>
...
<div class="text-center text-sm text-gray-400 border border-dashed border-gray-600 rounded p-4 my-2">Screenshot pending: WebSocket — new customer appears on second device</div>
...
<img src="/m0/33-settings-page.png" alt="Settings page" class="rounded shadow" />
